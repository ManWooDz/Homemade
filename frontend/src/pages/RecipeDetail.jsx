...
export default function RecipeDetail({
    ...
    return [
      {
        ...
        name: "Green Oak",
        image:
          "https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80",
        selected: true,
      },
      {
        id: 2,
        name: "Tomatoes",
        image:
          "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80",
        selected: true,
      },
      {
        id: 3,
        name: "Purple cabbage",
        image:
          "https://images.unsplash.com/photo-1596484552834-6a58f8510a76?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80",
        selected: true,
      },
    ];
  });
  ...
  // Shared with the sheet's drag gesture so the scroll-to-bottom trigger below
  // can move it without fighting manual drag.
      ...
      <div className="w-full max-w-107.5 bg-white h-full relative overflow-hidden flex flex-col shadow-2xl">
        ...
        >
          ...
          >
            ...
            <h3 className="text-xl font-medium text-black mb-4">Ingredient</h3>
            <div className="flex flex-col gap-3">
              {ingredients.map((ing) => (
                <div
                  key={ing.id}
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col justify-center">
                      <span className="font-medium text-black text-[15px] capitalize">
                        {ing.name}
                      </span>
                    </div>
                  </div>
              ...
              <button
                onClick={() =>
                  onConfirm(ingredients.filter((ing) => ing.selected))
                }
